...
-- 种子数据：教学评价
INSERT IGNORE INTO sys_evaluation (id, student_id, teacher_id, offering_id, score_1, score_2, score_3, score_4, score_5, comment, status) VALUES
...
-- 种子数据：培养方案
INSERT IGNORE INTO sys_training_plan (id, major, grade, total_credits, required_credits, elective_credits, description, status) VALUES
